...
#     d1 = {v: k for k, v in reversed_d.items()}
#     return predicted_d
...
encrypted_text = "gsvjf rxpyi ldmul cqfnk hlevi gsvoz abwlt"
# Substitution dictionary (example, it may not match the actual encryption)
d = {
    'a': 'b', 'b': 'c', 'c': 'd', 'd': 'e', 'e': 'f', 'f': 'g', 'g': 'h', 'h': 'i', 'i': 'j',
    'j': 'k', 'k': 'l', 'l': 'm', 'm': 'n', 'n': 'o', 'o': 'p', 'p': 'q', 'q': 'r', 'r': 's',
    's': 't', 't': 'u', 'u': 'v', 'v': 'w', 'w': 'x', 'x': 'y', 'y': 'z', 'z': 'a'
...
# Predict the substitution dictionary using cryptanalysis
predicted_d = cryptanalyse_substitution(encrypted_text)
print("Predicted substitution dictionary:", predicted_d)

# Decrypt the text using the predicted substitution dictionary
decrypted_text = substitution_decrypt(encrypted_text, predicted_d)
print("Decrypted text:", decrypted_text)

def count_correct_pairs(dict1, dict2):
    count = 0
    for key in dict1:
        # Check if the key exists in dict2 and the values match
...
dict2 = {
    'a': 'b', 'b': 'c', 'c': 'e', 'd': 'e', 'e': 'f', 'f': 'g', 'g': 'h', 'h': 'j', 'i': 'j',
    'j': 'k', 'k': 'l', 'l': 'm', 'm': 'n', 'n': 'o', 'o': 'p', 'p': 'q', 'q': 'r', 'r': 's',
    's': 't', 't': 'u', 'u': 'v', 'v': 'w', 'w': 'x', 'x': 'y', 'y': 'z', 'z': 'a'
}

correct_pairs_count = count_correct_pairs(dict1, dict2)
print("Number of correctly matched key-value pairs:", correct_pairs_count)
